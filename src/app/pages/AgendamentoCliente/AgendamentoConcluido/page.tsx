...
import DownloadButton from '/workspaces/salao-senac-web/src/components/Button/ButtonDownloadPDF/DownloadButton';
...
export default function AgendamentoConcluido() {
    ...
    if (!isClient) {
        return <div>Loading...</div>; // Exibe algo enquanto espera o código ser executado no cliente
    }
