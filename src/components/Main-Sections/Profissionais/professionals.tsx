  ...
  return (
    <section className="professionals-section">
      <div className="professionals-left">
        ...
        <h1>PROFISSIONAIS</h1>
        <p>
          Conheça todos nossos experts que estão à sua disposição para cuidar do
          seu cabelo.
        </p>
      </div>
      <div className="professionals-right">
        ...
        <div className="professional-card">
          ...
          <div className="social-icons">
            <a href="#">
              <img
                src="/img/icons/gray-instagram-icon.png"
                className="professionals-icons"
                alt="Instagram"
              />
            </a>
            <a href="#">
              <img
                src="/img/icons/gray-tiktok-icon.png"
                className="professionals-icons"
                alt="TikTok"
              />
            </a>
